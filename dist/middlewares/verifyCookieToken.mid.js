...
exports.VerifyCookieTokenMID = void 0;
...
let VerifyCookieTokenMID = class VerifyCookieTokenMID {
    ...
    async use(req, res, next) {
        ...
        let isValid = false;
        let _id = '';
        jwt.verify(refreshToken, environment_1.Env.JWT_USER_SESSION_REFRESH_SECRET || '', (err, decoded) => {
            if (err) {
                isValid = false;
            }
            else {
...
//# sourceMappingURL=verifyCookieToken.mid.js.map